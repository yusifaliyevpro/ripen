...
This is useful when using [sfw](https://github.com/SocketDev/sfw-free) to sandbox package installations and prevent supply-chain attacks. Enable it in the settings screen (`S`) under **SFW firewall**.
