...
- **Clipboard-first** — copies the ready-to-run update command to your clipboard on `Enter`, nothing is executed for you
- **Publish age** — shows how long ago each latest version was published (useful for pnpm's `minimumReleaseAge`)
...
- **Global packages** — check global installs with `ripen -g`
